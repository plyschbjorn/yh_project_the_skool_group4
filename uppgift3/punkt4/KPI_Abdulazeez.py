...
df = pd.read_csv(DATA_DIR / "beviljade_platser_full_2019_2024.csv", sep=",", encoding="utf-8-sig")
df.columns = df.columns.str.strip()

df_schablon = pd.read_excel(PROJECT_ROOT / "files" / "2024_tabell3.xlsx", sheet_name="Tabell 3", skiprows=5)
